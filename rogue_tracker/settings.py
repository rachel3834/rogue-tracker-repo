...
Generated by ./manage.py tom_setup on Oct. 20, 2025, 7:01 p.m.
...
ROOT_URLCONF = 'rogue_tracker.urls'
...
WSGI_APPLICATION = 'rogue_tracker.wsgi.application'
...
MANAGERS = [('rstreet', 'rstreet@lco.global')]  # List of managers who should receive registration emails
...
EMAIL_HOST_USER = 'rstreet@lco.global'  # Email address for the account sending emails
...
SERVER_EMAIL = "rstreet@lco.global"  # Email address used as the "from" address if EMAIL_HOST_USER is not needed
